...
def load_environment(global_conf, app_conf):
    ...
    conf = plastic_auth_ui.conf  # Empty dictionary
    ...
    conf.update(conv.check(conv.struct(
        {
            ...
            'cookie': conv.default('plastic-auth-ui'),
            'database': conv.default('plastic_auth_ui'),
...
#                ),
    ...
    if not errorware['debug']:
        ...
        errorware['error_subject_prefix'] = conf.get('error_subject_prefix', 'Plastic-Auth-UI Error: ')
